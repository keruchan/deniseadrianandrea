...
render_dashboard_page([
    ...
    'content' => function () use ($dash, $hasClasses) {
        ...
        <div class="metric-grid insights-summary-grid mt-4">
            ...
            <a class="metric-card metric-card-link tone-amber" href="<?php echo e($students . '?sort=participation'); ?>"><div class="metric-icon"><i class="bi bi-chat-square-text"></i></div><div><div class="metric-label">Participation rate</div><div class="metric-value"><?php echo insights_num($dash['participation_rate'], 1); ?></div><div class="metric-note">Rank by participation <i class="bi bi-arrow-right-short"></i></div></div></a>
            ...
            <div class="dash-class-grid">
                <?php foreach ($dash['classes'] as $c): ?>
                    ...
                    <article class="dash-class-card">
                        ...
                        <?php if ($c['at_risk'] > 0 || $c['pending'] > 0 || $c['missing_students'] > 0): ?>
